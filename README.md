...
Start de Arduino → zou LoRa gereed moeten melden.
...
reed-statussen
luikstatus
Verander de drempel → ESP32 verstuurt 'T'-pakket → Arduino past waarde aan.
...
Laat het weten als je ook een **GitHub badge header**, **screenshots-sectie**, of een **diagram van de L
